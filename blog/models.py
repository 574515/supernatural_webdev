...
class BlogPost(models.Model):
	...
	def getPubDateFormat(self):
		return str(self.pub_date.strftime("%d.%m.%Y, %H:%M"))

	def getUpdDateFormat(self):
		return str(self.upd_date.strftime("%d.%m.%Y, %H:%M"))

	def seralizeBlogPost(self):
		return {
			'title': self.title,
			'body': self.body,
...
class Comment(models.Model):
	...
	def getCreateDateFormat(self):
		return str(self.created_at.strftime("%d.%m.%Y, %H:%M"))
